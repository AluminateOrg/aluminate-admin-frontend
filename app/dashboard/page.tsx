          ...
          <div className="space-y-3">
            <div className="flex items-start space-x-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Berkeley Engineering container requires attention</p>
                <p className="text-xs text-muted-foreground">Payment overdue - access suspended</p>
              </div>
            ...
            <div className="flex items-start space-x-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Stanford University container using 85% memory</p>
              </div>
